...
public class MainActivity1 extends AppCompatActivity {
    ...
    private Button button0, button1, button2, button3, button4, button5, button6, button7,
            button8, button9, buttonAdd, buttonMultiply, buttonSubs, buttonDivision, buttonPoint, buttonLog,
            buttonPower, buttonEqual, buttonClear, buttonPar,buttonCos,buttonSin,buttonLn,buttonTan,buttonAbs,buttonExp,buttonPi,buttonInverce;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonInverce = findViewById(R.id.button_inverce);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.cal_device:
                ...
                break;
            case R.id.cal_temp:
                startActivity(new Intent(MainActivity1.this, MainActivity4.class));
                break;
            case R.id.cal_time:
                startActivity(new Intent(MainActivity1.this, MainActivity5.class));
                break;


            case R.id.cal_data:
                startActivity(new Intent(MainActivity1.this, MainActivity6.class));
                break;
        ...
        switch (data) {
            ...
            case "()":
                ...
                if(pos == -1){
                    ...
                    pos = inputText.getText().length() + 1;
    ...
    public void backspaceBtn(View view) {
        ...
        String inp = "";
        if(cursorPos >= 4) {
            inp = inputText.getText().toString().substring(cursorPos - 4, cursorPos);
        }
        String inp1 = "";
        if(cursorPos >= 3) {
            inp1 = inputText.getText().toString().substring(cursorPos - 3, cursorPos);
        }
        String inp2 = "";
        if(cursorPos >= 5) {
            inp2 = inputText.getText().toString().substring(cursorPos - 5, cursorPos);
        }
        String inp3 = "";
        if(cursorPos >= 6) {
            inp3 = inputText.getText().toString().substring(cursorPos - 6, cursorPos);
        }
        if (cursorPos != 0 && textLen != 0) {
            if(inp != "" && (inp.equals("sin(") || inp.equals("cos(") || inp.equals("tan(") || inp.equals("abs(") || inp.equals("exp("))){
            ...
            else if(inp2 != "" && inp2.equals("sqrt(")){

                SpannableStringBuilder selection = (SpannableStringBuilder) inputText.getText();
                selection.replace(cursorPos - 5, cursorPos, "");
                inputText.setText(selection);
                input = inputText.getText().toString();
                pos -= 5;

            }
            else if(inp3 != "" && inp3.equals("log10(")){
